export const profiles = {
  A: {
    id: 'A',
    profileTag: 'A Mulher que Deixa Tudo para Depois',
    title: 'O seu teste identificou o padrão da Mulher que Deixa Tudo para Depois.',
    description: [
      'Você costuma colocar as necessidades dos outros na frente das suas e acaba deixando seus próprios planos para depois.',
  ...
  B: {
    id: 'B',
    profileTag: 'A Prisioneira da Dúvida',
    title: 'O seu teste identificou o padrão da Prisioneira da Dúvida.',
    description: [
      'Você pensa muito antes de decidir e costuma imaginar tudo que pode dar errado.',
  ...
  C: {
    id: 'C',
    profileTag: 'A Mulher Adormecida',
    title: 'O seu teste identificou o padrão da Mulher Adormecida.',
    description: [
      'Você passou muito tempo vivendo para outras pessoas e acabou se afastando dos próprios desejos.',
  ...
  D: {
    id: 'D',
    profileTag: 'A Mulher sem Direção',
    title: 'O seu teste identificou o padrão da Mulher sem Direção.',
    description: [
      'Você sente que precisa mudar, mas ainda não sabe qual caminho seguir.',
